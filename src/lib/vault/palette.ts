/** 26 fixed colours. Every pixel on the canvas is one of these. */
...
export const RAMPS: Record<string, string[]> = { stone:['k','0','1','2','3','5','4'], warm:['k','0','d','d','b','Y','o'], s:['k','0','1','D','S','s','w'], t:['k','0','U','T','t','i','w'], v:['k','0','2','V','v','m','w'], y:['k','0','d','Y','y','o','w'] };

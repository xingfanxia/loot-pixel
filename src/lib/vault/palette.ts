/**
 * The art palette: 35 fixed colours (h/H/n are skin midtones for portrait decks). Every card-art
 * pixel is one of these; the art scripts parse this literal. Every canvas pixel is a PAL colour.
 */
...
/** Neon colours for themes' rooms and card chrome only, never card art: e/E cyan, q/Q hot pink. */
Object.assign(PAL, { e:'#2ee6ff', E:'#12689e', q:'#ff3d8b', Q:'#8e1f63' });
...
/** Theme ramps on the neon colours (outside the literal above, which the quantiser reads for dither pairs). */
Object.assign(RAMPS, { steel:['k','0','1','D','5','S','s'], cyan:['k','0','U','E','e','i','w'], pink:['k','0','2','Q','q','p','w'] });
